        ...
        web::scope("/api")
            ...
            .service(
                web::scope("/auth")
                    ...
                    .service(web::resource("/me").route(web::get().to(auth_controller::me)))
                    .service(
                        web::scope("/oauth2")
                            .service(
                            ...
                            .service(
                                web::resource("/token")
                                    .route(web::post().to(oauth2_controller::token)),
                            ),
                    ),
            )
            .service(
                web::scope("/reviews")
                    .service(
                        web::resource("/public_key")
                            .route(web::get().to(app_review_controller::get_public_key)),
                    )
                    .service(
                        web::resource("/sign").route(web::post().to(app_review_controller::sign)),
                    )
                    .service(web::resource("").route(web::get().to(app_review_controller::get)))
                    .service(
                        web::resource("/delete")
                            .route(web::delete().to(app_review_controller::delete)),
                    ),
            ),
    );
